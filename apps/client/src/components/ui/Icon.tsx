...
const paths: Record<string, string> = {
  ...
  eyeOff:
    'M3 3l18 18 M10.58 10.58a3 3 0 004.24 4.24 M9.88 5.09A10.94 10.94 0 0112 5c7 0 11 7 11 7a17.6 17.6 0 01-3.19 4.09M6.1 6.1A17.5 17.5 0 001 12s4 7 11 7a10.9 10.9 0 005.9-1.73',
};
