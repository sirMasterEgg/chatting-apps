  ...
  return (
    <div className="flex items-center gap-3 rounded-[20px] border border-frame bg-canvas-alt px-3 py-2">
      {draft.kind === 'image' && draft.previewUrl ? (
        ...
        <div className="flex h-12 w-12 flex-none items-center justify-center rounded-[10px] bg-slate text-ink/60">
      ...
      <div className="min-w-0 flex-1">
        ...
        {sendPhase === 'sending' ? (
          <div className="mt-1 flex items-center gap-1.5 font-mono text-[10px] uppercase tracking-[1px] text-mint-text">
